 ...
 *
 */
public class TestAmqpEventReceiver
{
    private static final Log LOG = Log.findLog();
    private AmqpEventReceiver eventReceiver;
    ...
    public void setUp() throws Exception
    {
        ...
        eventReceiver = new AmqpEventReceiver(
    ...
    public void testWithMethod() throws Exception
    {
        ...
        final Delivery d = new Delivery(new Envelope(42L, false, "amqp-event", "default"), new BasicProperties.Builder().build(), problemJson.getBytes(Charsets.UTF_8));

        eventReceiver.withDelivery(d);
    }
}
